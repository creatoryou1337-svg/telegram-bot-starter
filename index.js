// newbotjsrw.js - КЛИКЕР С ПРОГРЕССИЕЙ
console.log('=== ЗАПУСК КЛИКЕРА С ПРОГРЕССИЕЙ ===');
...
bot.launch()
    .then(() => {
        ...
        console.log('================================');
        console.log('🎮 Функции:');
        console.log('• Прогрессивная система уровней');
        console.log('• Магазин улучшений');
        console.log('• Топ игроков');
        console.log('• Анти-спам защита');
        console.log('================================');
        console.log('📱 Тестируйте в Telegram:');
        console.log('1. Откройте @tgclickrw');
        console.log('2. Напишите /start');
        console.log('3. Кликайте кнопку!');
        console.log('================================');
    })
    .catch(err => {
